var questionArray = [
    {
        ...
        answers: [
            'PC: "Are you sure you should still be playing, its getting really late?',
        ...
        correct: 'PC: "Are you sure you should still be playing, its getting really late?'
    }
];
...
$(document).ready(function(){
    ...
    $(document).on("click","#submit", function checkAnswer(){
        ...
        userGuess = $('input[name=answer]:checked').val()
            if (userGuess === theRightOne && questionNum < 13){
                correctGuess++;
                $("#playZone").empty().html("<h4>Correct</h4>");
                setTimeout(loadQuestion, 1000);
            } else if (userGuess === theRightOne && questionNum === 13) {
                correctGuess++;
                $("#playZone").empty().html("<h4>Correct</h4>");
